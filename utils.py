...
#dataset_train = TemporaryFile()
#dataset_test = TemporaryFile()
...
dataset_train_cat = dataset['train_cat']
dataset_train_dog = dataset['train_dog']
dataset_test_cat = dataset['test_cat']
dataset_test_dog = dataset['test_dog']

np.savez('dataset_train.npz',dataset_train_cat,dataset_train_dog)

np.savez('dataset_test.npz',dataset_test_cat,dataset_test_dog)

#print(dataset_train_cat.shape)
#print(dataset_train_dog.shape)
#print(dataset_test_cat.shape)
#print(dataset_test_dog.shape)
